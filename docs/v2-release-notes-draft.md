...
- zip SHA-256: `2d60f31544a5f0fe9c88bfad5f7422d56e5b2f15b06b4136ac54eb091c0a87af`
...
The recorded package includes post-candidate fixes for wardrobe transition rest-pose preparation, live wardrobe transition and Spout2 profile setting updates for running renderers, Spout2 profile save separation from window state, explicit Spout2 settings save wording, profile output runtime applicability labeling in the editor and navigation, launch-time field classification cleanup, startup presentation suppression from Spout2 output, distinct startup / wardrobe frame roles for Spout2 output, startup progress shader separation from wardrobe transition art, startup scene-state naming cleanup, Renderer tray and Supervisor UNAnimator naming cleanup, Renderer and Supervisor Spout2 Only minimized labeling, extended function-key binding regression coverage, and Supervisor UNAnimator list truncation disclosure.
