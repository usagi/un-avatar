...
- Portable zip SHA-256: `0758f9e05ea17e604bb3d907eb1c177733be44d4285a59bcbda2d92ae9524ea2`
...
- Window Preview: preview visible, Spout2 disabled, local preview restored if it had been hidden.
...
- Spout2 Only (HIDE): Spout2 enabled, preview hidden for local desktop use, rendering continues in OBS / Spout receiver.
...
- Returning from Spout2 Only (HIDE) to Window Preview restores preview before disabling Spout2, so the user is not left with Spout2 off and preview still hidden.
- 720p / 1080p buttons change Spout2 output resolution only; they do not implicitly restore or hide preview.
...
- Window Preview, Spout2 + Preview, and Spout2 Only (HIDE) map to the same behavior as Supervisor runtime buttons.
