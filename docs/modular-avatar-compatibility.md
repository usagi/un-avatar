...
- `[~]` MA Material Swap
  ...
  - remaining: asset group / texture references, and full continuous parameter evaluator behavior beyond direct `set_parameter` updates.
- `[~]` MA Material Setter
