...
- `[~]` MA Menu Item / Menu Group / Menu Installer
  ...
  - remaining: external menu asset expansion, loop handling, and richer UI surface beyond runtime wardrobe candidate activation.
- `[~]` MA Parameters
