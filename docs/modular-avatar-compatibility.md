...
- `[~]` MA Material Swap
  ...
  - remaining: asset group / texture references, and continuous parameter state evaluation beyond explicit `activate_action` lookup.
- `[~]` MA Material Setter
  ...
  - remaining: full reactive object integration with continuous parameter evaluation, broader component reference diagnostics, and material property override mapping beyond slot replacement.
- `[ ]` Blendshape Sync
