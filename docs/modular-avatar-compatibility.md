...
- `[~]` MA Object Toggle
  ...
  - remaining: full reactive object integration with inherited active-state conditions beyond the captured parent chain and continuous animator-style evaluation.
- `[~]` MA Material Swap
