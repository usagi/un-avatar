...
| [`v2-release-notes-draft.md`](v2-release-notes-draft.md) | v2 beta release notes の草稿、検証済み範囲、既知制限、手動確認項目 |
| [`v2-manual-release-checklist.md`](v2-manual-release-checklist.md) | v2 beta 実機確認の証跡テンプレート、GUI / tray / Spout2 / migration checklist |
