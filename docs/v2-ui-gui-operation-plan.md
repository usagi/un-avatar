...
- Supervisor Renderer detail panes must not impose a fixed UNAnimator candidate cap. Large imported menus should stay responsive through grouping, filtering, virtualization, or a bounded scroll region while keeping every normalized action reachable from the same live-operation surface.
