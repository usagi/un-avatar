...
- Mask filter texture は既存 root `textureAssets` に統合し、MeshCutter / VertexFilter component payload は `maskTextureAssetId`、material index、delete mode だけを持つ。MeshCutter 専用 asset pool は作らない。
