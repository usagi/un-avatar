...
- UV animation は UNToon v2 の基本機能として扱う。Exporter は MToon `_UvAnim*` と lilToon `_MainTex_ScrollRotate` を正規化し、Renderer は同じ animated UV を base / shade / normal / occlusion / rim / emissive / outline mask へ適用する。
