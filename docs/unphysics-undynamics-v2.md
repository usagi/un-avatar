...
2. PhysBone particle radius curve を、source-neutral chain sample metadata と solver hit radius の問題として詰める。v2 初期では定数 `hit_radius` のみ solver 入力に使う。
