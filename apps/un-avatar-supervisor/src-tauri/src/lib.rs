...
mod tests {
	...
	fn runtime_telemetry_reads_json_snapshot() {
		...
		assert_eq!(
			...
			Some("6 dynamics groups carry stretch limits that are metadata-only in the current solver")
		);
	}
