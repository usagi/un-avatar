...
<fieldset class={`unified-color-field ${className}`} data-hint={hint}>
	...
	<div class="color-summary">
		<label class="color-picker-swatch" aria-label={`${label} picker`}>
			...
			<input type="color" value={hex} {disabled} oninput={(event) => setHex((event.currentTarget as HTMLInputElement).value)} />
		</label>
		<select
			value={mode}
			{disabled}
		...
		<div class="color-channel-grid">
			<label
				>R<input
					...
					{disabled}
					onchange={(event) => setRgbByte(0, Number((event.currentTarget as HTMLInputElement).value))}
				/></label
			>
			<label
				>G<input
					...
					{disabled}
					onchange={(event) => setRgbByte(1, Number((event.currentTarget as HTMLInputElement).value))}
				/></label
			>
			<label
				>B<input
					...
					{disabled}
					onchange={(event) => setRgbByte(2, Number((event.currentTarget as HTMLInputElement).value))}
				/></label
			>
		</div>
		...
		<div class="color-channel-grid">
			<label
				>R<input
					...
					max="1"
					step="0.01"
					value={rgb[0].toFixed(2)}
					{disabled}
					onchange={(event) => setRgbChannel(0, Number((event.currentTarget as HTMLInputElement).value))}
				/></label
			>
			<label
				>G<input
					...
					max="1"
					step="0.01"
					value={rgb[1].toFixed(2)}
					{disabled}
					onchange={(event) => setRgbChannel(1, Number((event.currentTarget as HTMLInputElement).value))}
				/></label
			>
			<label
				>B<input
					...
					max="1"
					step="0.01"
					value={rgb[2].toFixed(2)}
					{disabled}
					onchange={(event) => setRgbChannel(2, Number((event.currentTarget as HTMLInputElement).value))}
				/></label
			>
		</div>
	{:else if mode === "rgb_hex"}
		<label class="hex-field"
			>Hex<input
				...
				pattern="#?[0-9a-fA-F]{6}"
				{disabled}
				onchange={(event) => setHex((event.currentTarget as HTMLInputElement).value)}
			/></label
		>
	{:else}
		<div class="color-channel-grid">
			<label
				>H<input
					...
					{disabled}
					onchange={(event) => setHsl("h", Number((event.currentTarget as HTMLInputElement).value))}
				/></label
			>
			<label
				>S<input
					...
					{disabled}
					onchange={(event) => setHsl("s", Number((event.currentTarget as HTMLInputElement).value))}
				/></label
			>
			<label
				>L<input
					...
					{disabled}
					onchange={(event) => setHsl("l", Number((event.currentTarget as HTMLInputElement).value))}
				/></label
			>
		</div>
	{/if}
