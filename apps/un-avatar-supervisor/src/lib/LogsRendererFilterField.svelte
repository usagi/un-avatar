<script lang="ts">
	...
	import { rendererLogFilterFromValue, type RendererLogData, type RendererLogFilter } from "./rendererLogs";
...
<label class="logs-filter-field logs-filter-field--select">
	...
	<select
		...
		onchange={(e) => {
			logsRendererFilter = rendererLogFilterFromValue((e.currentTarget as HTMLSelectElement).value);
		}}
	>
