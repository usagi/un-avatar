...
<div class="lighting-control-cluster lighting-angle-cluster">
	...
	<ProfileRangeNumberField
		...
		onChange={(value) => onUpdateSettingValue("environment.lighting.directional.azimuth_deg", value)}
	/>
	<ProfileRangeNumberField
		...
		step={1}
		disabled={busy || !enabled}
		onChange={(value) => onUpdateSettingValue("environment.lighting.directional.elevation_deg", value)}
	/>
</div>
