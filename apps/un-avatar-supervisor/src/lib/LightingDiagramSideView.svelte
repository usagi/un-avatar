...
<svg viewBox="0 0 220 136" role="img">
  ...
  <line x1={diagram.sideRayEndX} y1={diagram.sideRayEndY} x2={diagram.sideProjectionX} y2={diagram.sideProjectionY} class="lighting-projection-line" />
  <line x1={diagram.sideRayStartX} y1={diagram.sideRayStartY} x2={diagram.sideRayEndX} y2={diagram.sideRayEndY} class="lighting-ray-line" marker-end="url(#lighting-arrow-side)" />
