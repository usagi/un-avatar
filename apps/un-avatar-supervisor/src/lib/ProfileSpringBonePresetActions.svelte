<script lang="ts">
	...
	import { springBonePresetLabel, type SpringBoneCategoryOverrideSetting } from "./springBonePresets";
	...
	<div class="spring-bone-preset-actions">
		...
		{#each presets as preset}
			<button
				...
				class="secondary"
				{disabled}
				onclick={() => onUpdateSettingValue(`physics.spring_bone.overrides.${override.category}.preset`, preset)}
			>
