<script lang="ts">
	...
	export let setting: Pick<ProfileSurfaceSetting, "specular_enabled" | "specular_intensity" | "specular_power">;
...
<ProfileToggleField
	...
	disabled={busy}
	onChange={(checked) => onUpdateSettingValue("effects.avatar.specular.enabled", checked)}
/>
<ProfileRangeNumberField
	...
	onChange={(value) => onUpdateSettingValue("effects.avatar.specular.intensity", value)}
/>
<ProfileRangeNumberField
	...
	step={1}
	disabled={busy || !setting.specular_enabled}
	onChange={(value) => onUpdateSettingValue("effects.avatar.specular.power", value)}
/>
