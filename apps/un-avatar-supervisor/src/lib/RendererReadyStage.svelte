	...
	<div class="stage-main">
		<div class="stage-title-row">
			<div>
				...
				<p>
					{launchGroupName
						? $_("renderers.ready.group_count", { values: { count: launchGroupCount } })
						: basename(setting.avatar_path)}
				</p>
			</div>
		</div>
		<RendererReadyChips {setting} />
	</div>
	<RendererReadyMetrics {runningCount} {issueCount} {profileCount} {profileGroupCount} />
</section>
