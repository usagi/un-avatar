...
<div class="subgroup">
  <label
    class="profile-channel-heading"
    data-hint={$_("profiles.hints.output.spout_sender")}
  >
    <input
      type="checkbox"
  ...
  <div class="section-grid profile-channel-fields">
    <label
      class="profile-field-full"
      data-hint={$_("profiles.hints.output.spout_name")}
    >
    ...
    <div class="spout-resolution-fields">
      <div class="subgroup-heading output-resolution-preset-row">
        ...
        <ProfileSpoutResolutionPresetRow
          disabled={!setting.spout_enabled || busy}
          {onApplySpoutResolutionPreset}
        />
      </div>
      <ProfileSpoutSizeFields
        {setting}
        disabled={!setting.spout_enabled || busy}
        {onUpdateSettingValue}
      />
