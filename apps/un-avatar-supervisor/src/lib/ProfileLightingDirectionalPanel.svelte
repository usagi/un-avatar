<script lang="ts">
	...
	$: directionalBasis = setting.lighting_directional_follow_camera_yaw ? "camera" : "world";
</script>
...
<details class="effect-panel lighting-directional-panel" open>
	...
	<DirectionalLightingBody {setting} {busy} {colorDisplayMode} {onColorModeChange} {onUpdateSettingValue} />
</details>
