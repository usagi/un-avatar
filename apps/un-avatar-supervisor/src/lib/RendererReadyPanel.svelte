<script lang="ts">
  ...
  import {
    RENDERER_READY_STATS,
    rendererReadySubtitle,
    rendererReadyTitle,
  } from "./rendererReadyLabels";
  ...
  $: readySubtitle = rendererReadySubtitle(
    launchGroupName,
    launchTargetSetting,
    launchGroupCount,
    $_,
...
<div class="renderer-ready-panel">
  ...
  <div class="renderer-ready-actions">
    ...
    <button
      type="button"
      disabled={busy}
      onclick={() => void onRevealProfilesDir()}
