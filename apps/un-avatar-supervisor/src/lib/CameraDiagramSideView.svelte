...
<svg viewBox="0 0 220 136" role="img">
  ...
  <ellipse cx={diagram.sideTargetX} cy={diagram.sideTargetY} rx={diagram.sideOrbitRx} ry={diagram.sideOrbitRy} class="camera-orbit-line" />
  ...
  />
  <line x1={diagram.sideCameraX} y1={diagram.sideCameraY} x2={diagram.sideFovLeftX} y2={diagram.sideFovLeftY} class="camera-frustum-line" />
  <line x1={diagram.sideCameraX} y1={diagram.sideCameraY} x2={diagram.sideFovRightX} y2={diagram.sideFovRightY} class="camera-frustum-line" />
