...
export type VrmMetadataTranslator = (
  key: string,
...
export function fallbackVrmMetadata(
  path: string,
  reason: unknown,
  translate: VrmMetadataTranslator,
): VrmMetadataInfo {
  return {
    path,
...
const negativePermissionValues = new Set([
  "disallow",
  "false",
  "prohibited",
  "redistribution_prohibited",
]);
const limitedPermissionValues = new Set([
  "onlyauthor",
  "onlyseparatelylicensedperson",
]);
const conditionalPermissionValues = new Set([
  "required",
  "personalnonprofit",
  "personalprofit",
  "corporation",
...
export function vrmMetadataFieldLabel(
  label: string,
  translate: VrmMetadataTranslator,
): string {
...
export function vrmMetadataFieldValue(
  item: VrmMetadataField,
  translate: VrmMetadataTranslator,
): string {
